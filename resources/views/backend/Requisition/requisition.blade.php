    ...
    <tbody>
      @foreach($products as $product)
        <tr>
          ...
          <td>{{$product->brand}}</td>
          <td>
            <button class="btn btn-warning">{{$product->status}}</button>
          </td>
          <td>
            <a href="{{ route('details.requisition',[$product->id])}}" class="btn btn-primary">
              Details
            </a>
            <b></b>
            <a href="{{ route('delete.requisition',[$product->id])}}" class="btn btn-danger">
              Delete
            </a>
          </td>
        </tr>
  ...
  <div class="modal-dialog" role="document">
     <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="{{ route('store.requisition')}}" method="post" role="form" enctype="multipart/form-data">
            @csrf 
